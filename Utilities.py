...
class Utilities:
    ...
    def startup():
        ...
        while True:
            ...
            username: str = input('Database username [CECS-323-Spring-2024-user] -->')
            project: str = input('Mongo project name [CECS-323-Spring-2024] -->')
            hash_name: str = input('7-character database hash [1f77kcz] -->') or "1f77kcz"
